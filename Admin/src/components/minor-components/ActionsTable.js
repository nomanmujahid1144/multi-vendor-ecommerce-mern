...
import { ViewDriverDetails } from "../minor-components/ViewDriverDetails"
    ...
    if (props.isUnApprovedRestaurants) {
                                            ...
                                            <tbody className="text-sm  divide-gray-100">
                                                ...
                                                {!searchText ? <>
                                                    ...
                                                    {myFilteredData.map((item, index) => (
                                                        <tr key={index}>
                                                            <td className={`text-left text-xs px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <input className='mx-2' type="checkbox" id="DBID" name="DBID" value={item.DBID} />
                                                            </td>
                                                            <td className={`text-left  px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <img src={`${baseURL}${item.productPhoto}`} className={`text-left text-xs w-14 h-14 rounded-[50%]`} />
                                                            </td>
        ...
        return (
            <div className='py-2 bg-gray-50'>
                <div className='divide-y  divide-gray-100 bg-white rounded-lg  shadow-lg'>
                    <div className='px-5 pt-4 h-10 my-0 flex flex-col items-start justify-between'>
                        <h2 className='font-semibold text-gray-800 text-lg'>Restaurant Orders</h2>
                        <p className='text-xs'>Details</p>
                    </div>
                    <div className="w-full px-4 py-4 my-8 bg-white ">
                        <div className="flex items-start justify-between">
                                            ...
                                            <tbody className="text-sm  divide-gray-100">
                                                ...
                                                {!searchText ? <>
                                                    {data.slice(pagesVisited, pagesVisited + itemsPerPage).map((item, index) => (
                                                        <tr key={index}>
                                                            <td className={`text-left  px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}> {index + 1}</p>
                                                            </td>
                                                            <td className={`text-left text-md px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}>{item.details.map((product) => product.productId.name).join('/')}</p>
                                                            </td>
                                                            <td className={`text-left text-md px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}>{item.details.map((product) => product.quantity).join('/')}</p>
                                                            </td>
                                                            <td className={`text-left text-md px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}>R-{item.details.map((product) => product.productTotal).join('/R-')}</p>
                                                            </td>
                                                            <td className={`text-left text-md px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}>R-{item.deliveryCost}</p>
                                                            </td>
                                                            <td className={`text-left text-md px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}>R-{item.grandTotalPrice}</p>
                                                            </td>
                                                            <td className={`text-left text-md px-2 py-8 whitespace-nowrap ${index % 2 !== 0 ? 'bg-white' : 'bg-gray-50'}`}>
                                                                <p className={`text-left text-md `}>{item.status == 1 ? 'Approved' : 'Pending'}</p>
                                                            </td>
                                                        </tr>
                                                    ))}
                                                    <div className="px-4">
                                                        {showDetails ? (
                                                            <Modal open={isOpen} onClose={() => setIsOpen(false)} >
                                                                <ViewDriverDetails showDetails={showDetails} />
                                                            </Modal>
                                                        ) : null}
                                                    </div>
                                                </> : <>
