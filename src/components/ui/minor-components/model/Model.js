...
export const Modal = ({ open, onClose, children }) => {
    ...
    return ReactDom.createPortal(
        <>
            ...
            <div className=' fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white z-50 shaddow-lg rounded w-[90%] lg:w-[30%] md:w-[30%] sm:w-[95%]  overflow-hidden md:overflow-hidden'>
